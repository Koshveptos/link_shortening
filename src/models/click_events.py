...
class ClickEvent(Base):
    ...
    ip_address:Mapped[Optional[str]] = mapped_column(String(45),index=True,nullable=True) #для айти 4-6 
    country_code:Mapped[Optional[str]] = mapped_column(String(2),nullable=True)
    device_type: Mapped[Optional[str]] = mapped_column(String(100), index=True, nullable=True)
