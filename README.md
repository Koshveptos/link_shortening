...
Дописать профили администраторов, расширить тестирование и опитимизировать бд (нагрузочное показало что 1200 пользовательз с может немного задерживаться по тайм ауту) + добавить аналитики больше, ибо таблцу в бд создал - а расширенный функционал для аналитики нет
...
![img\locust.png](/img/pocritie_unit_inter.png "тестирование")

Результаты нагрузочного тестирования
![img\locust.png](/img/locust.png "нагрузочное")
